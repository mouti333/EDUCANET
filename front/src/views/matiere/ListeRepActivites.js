...
class ListeRepActivites extends Component {
    ...
    getusers(){
        axios.get(`http://localhost:8000/ReponseActivites/getAll/${localStorage.getItem('idGRP')}/${localStorage.getItem('idMat')}/${localStorage.getItem('idRep')}`).then((res=>{
          ...
          <Col xs="12" lg="12">
            <Card>
              <CardHeader>
                ...
                Liste des Reponses des Activites
              </CardHeader>
              <CardBody>
