...
class MesEtudiantsEnseignant extends Component {
    constructor() {
        super();
        this.state = {
          personnes: [],
    ...
    getusers(){
        axios.get(`http://localhost:8000/Etudiant/getAllETD/${localStorage.getItem('idAdmin')}/${localStorage.getItem("idGRP")}`).then((res=>{
...
export default MesEtudiantsEnseignant;
