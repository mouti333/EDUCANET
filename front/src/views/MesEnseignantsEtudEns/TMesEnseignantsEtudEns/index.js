...
class MesEnseignantsEtudEns extends Component {
    ...
    // }
    getusers(){
        axios.get(`http://localhost:8000/Enseignant/getAllEnseignantsParGroupe/${localStorage.getItem('idGoupe')}`).then((res=>{
...
//     }
//     getusers(){
//         axios.get("http://localhost:8000/Enseignant/getAllEnseignantsParGroupe/60900829ac8de62818769019").then((res=>{
//             this.setState({personnes:res.data.data})
//             console.log('personnes',this.state.personnes)
//         }))
